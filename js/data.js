...
const PACKS = [
  ...
  { id: "cat",   name: "Chaos",    emoji: "", cover: true, stickerFiles: 10, price: 3.99, stickers: 10, preview: 5,  desc: "Cats being dramatic about very small things." },
  { id: "soft",  name: "Coming Soon..",    emoji: "", price: 3.49, stickers: 22, preview: 5,  desc: "Gentle little moments for slow, cozy chats." },
  { id: "study", name: "Coming Soon..",  emoji: "", price: 4.99, stickers: 30, preview: 6,  desc: "Deadlines, coffee, and tiny wins for study days." },
  { id: "love",  name: "Coming Soon..",emoji: "", price: 5.49, stickers: 36, preview: 7,  desc: "Hearts and small messages for someone you like." }
];
